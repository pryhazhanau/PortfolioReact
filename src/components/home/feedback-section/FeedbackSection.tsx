...
const feedbacksList = [
    { id: 0, description: "Arseni Vasilevski Project Manager @Andersen", body: "You make a customer's vision a reality. Pleasant soft-skills, self-driven, reliable, true senior and perspective Teach Lead. Satisfied customers. Supportive team-member. Creative thinker.", img: Arseny },
