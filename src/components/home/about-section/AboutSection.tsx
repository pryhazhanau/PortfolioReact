        ...
        <div className="about-content-container">
          <div className="about-flex-container">
            <h1 className="body-text-spacero">
              My name is Uladzimir, and I am an iOS Developer hailing from
              Warsaw, Poland. Although I was born in Minsk, Belarus, I've found
              ...
              spent the last four years refining my iOS development skills
